...
def main_process(novel_id: str, server: int, start_index: int, end_index: int):
    try:
        ...
        download_novel(novel_id, server, start_index, end_index)
...
def main():
    ...
    parser.add_argument('-e_i', type=int, default=10, required=True, help='End index')
    ...
    main_process(args.id, args.s, args.s_i, args.e_i)
