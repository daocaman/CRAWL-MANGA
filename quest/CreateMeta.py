...
def quest_form_create_metadata():
    ...
    comic_info = select_file_question("Enter comic info file (optional): ", file_comic_json)
    bookmark = select_file_question("Enter bookmark file (optional): ", file_bookmarks)
